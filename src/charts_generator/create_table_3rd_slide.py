...
def generate_table(data):
    ...
    # Sau này gán cứng WIDTH RATIOS theo từng topic dứoi dạng dict
...
# def main():
#     pivot_this_week = prepare_table_data('./data/this_week.xlsx', 
#         main_topic='SHB', 
#         rows='Labels1',
...
#         aggfunc='count'
#     )
#     if pivot_this_week is None:
#         print("Error preparing data.")
#         return
#     generate_table(pivot_this_week)
